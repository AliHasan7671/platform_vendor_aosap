...
ALARM_PATH := vendor/aosap/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/aosap/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/aosap/prebuilt/common/media/audio/ringtones
