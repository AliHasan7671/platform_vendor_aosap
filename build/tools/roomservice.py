...
custom_dependencies = "aosap.dependencies"
org_manifest = "aosap-d"  # leave empty if org is provided in manifest
org_display = "AOSAP-Devices"  # needed for displaying
